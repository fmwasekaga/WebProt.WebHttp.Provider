...
namespace WebProt.WebHttp.Provider.Helpers
{
    ...
    public class Router : IDisposable
    {
        ...
        private class RouteEntry
        {
            ...
            public Func<IHttpContext, Dictionary<string, string>, Func<Task>, Task> Handler { get; set; }
        }
        ...
        public void Add(string route, Func<IHttpContext, Dictionary<string, string>, Func<Task>, Task> handler)
        {
        ...
        public bool TryGetValue(string localPath, out Func<IHttpContext, Dictionary<string, string>, Func<Task>, Task> handler, out Dictionary<string, string> data)
        {
            handler = null;
            data = null;
            if (_pathParser == null)
